...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/vasya/anaconda3/lib/python3.7/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/vasya/anaconda3/lib/python3.7/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "extra_compile_args": [
            "-O3"
        ],
        "include_dirs": [
            "/home/vasya/anaconda3/lib/python3.7/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "cython_files",
        "sources": [
            "find_new_clusters.pyx",
            "probabilistic_classifier_cython.pyx"
        ]
    },
    "module_name": "cython_files"
}
END: Cython Metadata */
...
#define __PYX_HAVE__find_new_clusters
#define __PYX_HAVE_API__find_new_clusters
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'find_new_clusters' */
static PyArrayObject *__pyx_f_17find_new_clusters_c_find_new_clusters(PyArrayObject *, int, PyArrayObject *, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "find_new_clusters"
extern int __pyx_module_is_main_find_new_clusters;
int __pyx_module_is_main_find_new_clusters = 0;

/* Implementation of 'find_new_clusters' */
...
static const char __pyx_k_rejected_inds[] = "rejected_inds";
...
static PyObject *__pyx_n_s_rejected_inds;
...
static PyObject *__pyx_pf_17find_new_clusters_c_find_new_clusters(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, int __pyx_v_l, PyArrayObject *__pyx_v_rejected_inds, int __pyx_v_n_neighbors); /* proto */
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags); /* proto */
static void __pyx_pf_5numpy_7ndarray_2__releasebuffer__(PyArrayObject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static int __pyx_pf_7cpython_5array_5array___getbuffer__(arrayobject *__pyx_v_self, Py_buffer *__pyx_v_info, CYTHON_UNUSED int __pyx_v_flags); /* proto */
static void __pyx_pf_7cpython_5array_5array_2__releasebuffer__(CYTHON_UNUSED arrayobject *__pyx_v_self, Py_buffer *__pyx_v_info); /* proto */
static PyObject *__pyx_float_1_0e_31;
...
static float __pyx_f_17find_new_clusters_euclidean_distance(PyArrayObject *__pyx_v_x_i, PyArrayObject *__pyx_v_x_j) {
  int __pyx_v_t;
  double __pyx_v_res;
  ...
  __pyx_pybuffernd_x_j.rcbuffer = &__pyx_pybuffer_x_j;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x_i.rcbuffer->pybuffer, (PyObject*)__pyx_v_x_i, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x_j.rcbuffer->pybuffer, (PyObject*)__pyx_v_x_j, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
 ...
 *     return np.sqrt(res)
 */
  __pyx_t_1 = (__pyx_v_x_i->dimensions[0]);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_t = __pyx_t_3;

    /* "find_new_clusters.pyx":11
 *     cdef double res = 0.0
 *     for t in range(x_i.shape[0]):
 *         res += (x_i[t] - x_j[t]) ** 2             # <<<<<<<<<<<<<<
 *     return np.sqrt(res)
 ...
 */
    ...
    __pyx_t_5 = -1;
    if (__pyx_t_4 < 0) {
      __pyx_t_4 += __pyx_pybuffernd_x_i.diminfo[0].shape;
      if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 0;
    } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_x_i.diminfo[0].shape)) __pyx_t_5 = 0;
    ...
    __pyx_t_5 = -1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_pybuffernd_x_j.diminfo[0].shape;
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_5 = 0;
    } else if (unlikely(__pyx_t_6 >= __pyx_pybuffernd_x_j.diminfo[0].shape)) __pyx_t_5 = 0;
    if (unlikely(__pyx_t_5 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_5);
      __PYX_ERR(0, 11, __pyx_L1_error)
    }
    __pyx_v_res = (__pyx_v_res + pow(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_x_i.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_x_i.diminfo[0].strides)) - (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_x_j.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_x_j.diminfo[0].strides))), 2.0));
  }

  /* "find_new_clusters.pyx":12
 *     for t in range(x_i.shape[0]):
 *         res += (x_i[t] - x_j[t]) ** 2
 *     return np.sqrt(res)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = PyFloat_FromDouble(__pyx_v_res); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_10 = NULL;
  ...
  __pyx_t_11 = __pyx_PyFloat_AsFloat(__pyx_t_7); if (unlikely((__pyx_t_11 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_WriteUnraisable("find_new_clusters.euclidean_distance", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_x_i.rcbuffer->pybuffer);
...
static PyObject *__pyx_pw_17find_new_clusters_1c_find_new_clusters(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_17find_new_clusters_c_find_new_clusters(PyArrayObject *__pyx_v_x, int __pyx_v_l, PyArrayObject *__pyx_v_rejected_inds, int __pyx_v_n_neighbors, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_u;
  int __pyx_v_num_pairs;
  PyArrayObject *__pyx_v_pairs = 0;
  PyArrayObject *__pyx_v_neighbors = 0;
  PyArrayObject *__pyx_v_dist_neighbors = 0;
  ...
  PyArrayObject *__pyx_v_to_keep = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_dist_matrix;
  __Pyx_Buffer __pyx_pybuffer_dist_matrix;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_dist_neighbors;
  __Pyx_Buffer __pyx_pybuffer_dist_neighbors;
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_rejected_inds;
  __Pyx_Buffer __pyx_pybuffer_rejected_inds;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_to_keep;
  __Pyx_Buffer __pyx_pybuffer_to_keep;
  ...
  __Pyx_RefNannySetupContext("c_find_new_clusters", 0);
  ...
  __pyx_pybuffer_dist_neighbors.pybuffer.buf = NULL;
  __pyx_pybuffer_dist_neighbors.refcount = 0;
  __pyx_pybuffernd_dist_neighbors.data = NULL;
  __pyx_pybuffernd_dist_neighbors.rcbuffer = &__pyx_pybuffer_dist_neighbors;
  ...
  __pyx_pybuffer_to_keep.pybuffer.buf = NULL;
  __pyx_pybuffer_to_keep.refcount = 0;
  __pyx_pybuffernd_to_keep.data = NULL;
  __pyx_pybuffernd_to_keep.rcbuffer = &__pyx_pybuffer_to_keep;
  __pyx_pybuffer_x.pybuffer.buf = NULL;
  __pyx_pybuffer_x.refcount = 0;
  __pyx_pybuffernd_x.data = NULL;
  __pyx_pybuffernd_x.rcbuffer = &__pyx_pybuffer_x;
  __pyx_pybuffer_rejected_inds.pybuffer.buf = NULL;
  __pyx_pybuffer_rejected_inds.refcount = 0;
  __pyx_pybuffernd_rejected_inds.data = NULL;
  __pyx_pybuffernd_rejected_inds.rcbuffer = &__pyx_pybuffer_rejected_inds;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer, (PyObject*)__pyx_v_rejected_inds, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 15, __pyx_L1_error)
  }
  __pyx_pybuffernd_rejected_inds.diminfo[0].strides = __pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_rejected_inds.diminfo[0].shape = __pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer.shape[0];

  /* "find_new_clusters.pyx":17
 * cpdef np.ndarray[np.int_t, ndim = 2] c_find_new_clusters(np.ndarray[np.float_t, ndim = 2] x, int l, np.ndarray[np.int_t, ndim = 1] rejected_inds, int n_neighbors):
 *     cdef:
 *         int u = x.shape[0] - l             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_u = ((__pyx_v_x->dimensions[0]) - __pyx_v_l);

  /* "find_new_clusters.pyx":18
 *     cdef:
 *         int u = x.shape[0] - l
 *         int num_pairs = rejected_inds.shape[0] * n_neighbors             # <<<<<<<<<<<<<<
 *         np.ndarray[np.int_t, ndim = 2] pairs = np.full((num_pairs, 2), -1, dtype=np.int)
 ...
 */
  __pyx_v_num_pairs = ((__pyx_v_rejected_inds->dimensions[0]) * __pyx_v_n_neighbors);

  /* "find_new_clusters.pyx":19
 *         int u = x.shape[0] - l
 *         int num_pairs = rejected_inds.shape[0] * n_neighbors
 *         np.ndarray[np.int_t, ndim = 2] pairs = np.full((num_pairs, 2), -1, dtype=np.int)             # <<<<<<<<<<<<<<
 *         np.ndarray[np.int_t, ndim = 1] neighbors
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_full); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_num_pairs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_empty); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_u); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_l + __pyx_v_u)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_np); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist_matrix.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_euclidean_distances); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_l); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Add(((PyObject *)__pyx_v_rejected_inds), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_x), __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  __pyx_t_8 = 0;
  ...
  if (PyFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[3] = {__pyx_t_3, __pyx_t_1, ((PyObject *)__pyx_v_x)};
    __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_8, 2+__pyx_t_8); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[3] = {__pyx_t_3, __pyx_t_1, ((PyObject *)__pyx_v_x)};
    __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_8, 2+__pyx_t_8); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  } else
  #endif
  {
    __pyx_t_5 = PyTuple_New(2+__pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 27, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (__pyx_t_3) {
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_8, ((PyObject *)__pyx_v_x));
    __pyx_t_1 = 0;
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    __pyx_t_8 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist_matrix.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_8 < 0)) {
      PyErr_Fetch(&__pyx_t_9, &__pyx_t_10, &__pyx_t_11);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist_matrix.rcbuffer->pybuffer, (PyObject*)__pyx_v_dist_matrix, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_7 = 0;
  __Pyx_DECREF_SET(__pyx_v_dist_matrix, ((PyArrayObject *)__pyx_t_4));
  __pyx_t_4 = 0;

  /* "find_new_clusters.pyx":30
 *     # return dist_matrix
 *     # for i in range(l, l+u):
 ...
 *         #     continue
 */
  __pyx_t_12 = (__pyx_v_rejected_inds->dimensions[0]);
  __pyx_t_13 = __pyx_t_12;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_13; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "find_new_clusters.pyx":33
 *         # if i - l not in rejected_inds:
 *         #     continue
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_n_neighbors); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_int); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __pyx_t_14 = ((PyArrayObject *)__pyx_t_3);
    {
      ...
      __pyx_t_15 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_neighbors.rcbuffer->pybuffer, (PyObject*)__pyx_t_14, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_15 < 0)) {
        PyErr_Fetch(&__pyx_t_11, &__pyx_t_10, &__pyx_t_9);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_neighbors.rcbuffer->pybuffer, (PyObject*)__pyx_v_neighbors, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_t_14 = 0;
    __Pyx_XDECREF_SET(__pyx_v_neighbors, ((PyArrayObject *)__pyx_t_3));
    __pyx_t_3 = 0;

    /* "find_new_clusters.pyx":34
 *         #     continue
 *         neighbors = np.zeros(n_neighbors, dtype=np.int)
 *         dist_neighbors = np.repeat(1.0e+31, n_neighbors)             # <<<<<<<<<<<<<<
 *         for j in range(l+u):
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_repeat); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_n_neighbors); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 34, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_2 = NULL;
    __pyx_t_15 = 0;
    ...
    if (PyFunction_Check(__pyx_t_5)) {
      PyObject *__pyx_temp[3] = {__pyx_t_2, __pyx_float_1_0e_31, __pyx_t_4};
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_15, 2+__pyx_t_15); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_5)) {
      PyObject *__pyx_temp[3] = {__pyx_t_2, __pyx_float_1_0e_31, __pyx_t_4};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_5, __pyx_temp+1-__pyx_t_15, 2+__pyx_t_15); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    } else
    #endif
    {
      __pyx_t_1 = PyTuple_New(2+__pyx_t_15); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (__pyx_t_2) {
        __Pyx_GIVEREF(__pyx_t_2); PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_t_2); __pyx_t_2 = NULL;
      }
      __Pyx_INCREF(__pyx_float_1_0e_31);
      __Pyx_GIVEREF(__pyx_float_1_0e_31);
      PyTuple_SET_ITEM(__pyx_t_1, 0+__pyx_t_15, __pyx_float_1_0e_31);
      __Pyx_GIVEREF(__pyx_t_4);
    ...
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer);
      __pyx_t_15 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer, (PyObject*)__pyx_t_16, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_15 < 0)) {
        PyErr_Fetch(&__pyx_t_9, &__pyx_t_10, &__pyx_t_11);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer, (PyObject*)__pyx_v_dist_neighbors, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
          Py_XDECREF(__pyx_t_9); Py_XDECREF(__pyx_t_10); Py_XDECREF(__pyx_t_11);
          __Pyx_RaiseBufferFallbackError();
        } else {
          PyErr_Restore(__pyx_t_9, __pyx_t_10, __pyx_t_11);
      ...
      __pyx_pybuffernd_dist_neighbors.diminfo[0].strides = __pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_dist_neighbors.diminfo[0].shape = __pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 34, __pyx_L1_error)
    }
    __pyx_t_16 = 0;
    __Pyx_XDECREF_SET(__pyx_v_dist_neighbors, ((PyArrayObject *)__pyx_t_3));
    __pyx_t_3 = 0;

    /* "find_new_clusters.pyx":35
 *         neighbors = np.zeros(n_neighbors, dtype=np.int)
 *         dist_neighbors = np.repeat(1.0e+31, n_neighbors)
 *         for j in range(l+u):             # <<<<<<<<<<<<<<
 *             if rejected_inds[i] + l == j:
 *                 continue
 */
    __pyx_t_15 = (__pyx_v_l + __pyx_v_u);
    __pyx_t_17 = __pyx_t_15;
    for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=1) {
      __pyx_v_j = __pyx_t_18;

      /* "find_new_clusters.pyx":36
 *         dist_neighbors = np.repeat(1.0e+31, n_neighbors)
 *         for j in range(l+u):
 *             if rejected_inds[i] + l == j:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      __pyx_t_20 = -1;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_pybuffernd_rejected_inds.diminfo[0].shape;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_20 = 0;
      } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_rejected_inds.diminfo[0].shape)) __pyx_t_20 = 0;
      if (unlikely(__pyx_t_20 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_20);
        __PYX_ERR(0, 36, __pyx_L1_error)
      }
      __pyx_t_21 = ((((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_rejected_inds.diminfo[0].strides)) + __pyx_v_l) == __pyx_v_j) != 0);
      if (__pyx_t_21) {

        /* "find_new_clusters.pyx":37
 *         for j in range(l+u):
 *             if rejected_inds[i] + l == j:
 *                 continue             # <<<<<<<<<<<<<<
 *             # tmp = euclidean_distance(x[i], x[j])
 ...
 */
      ...
      __pyx_t_20 = -1;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_pybuffernd_dist_matrix.diminfo[0].shape;
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_20 = 0;
      } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_dist_matrix.diminfo[0].shape)) __pyx_t_20 = 0;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_pybuffernd_dist_matrix.diminfo[1].shape;
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_20 = 1;
      } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_dist_matrix.diminfo[1].shape)) __pyx_t_20 = 1;
      if (unlikely(__pyx_t_20 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_20);
        __PYX_ERR(0, 39, __pyx_L1_error)
      }
      __pyx_v_tmp = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_dist_matrix.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_dist_matrix.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_dist_matrix.diminfo[1].strides));

      /* "find_new_clusters.pyx":40
 *             # tmp = euclidean_distance(x[i], x[j])
 *             tmp = dist_matrix[i, j]
 *             for k in range(n_neighbors):             # <<<<<<<<<<<<<<
 *                 if tmp < dist_neighbors[k]:
 ...
 */
      __pyx_t_20 = __pyx_v_n_neighbors;
      __pyx_t_24 = __pyx_t_20;
      for (__pyx_t_25 = 0; __pyx_t_25 < __pyx_t_24; __pyx_t_25+=1) {
        __pyx_v_k = __pyx_t_25;

        /* "find_new_clusters.pyx":41
 *             tmp = dist_matrix[i, j]
 *             for k in range(n_neighbors):
 *                 if tmp < dist_neighbors[k]:             # <<<<<<<<<<<<<<
 *                     dist_neighbors[k:] = np.roll(dist_neighbors[k:], 1)
 ...
 */
        ...
        __pyx_t_27 = -1;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_pybuffernd_dist_neighbors.diminfo[0].shape;
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_27 = 0;
        } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_dist_neighbors.diminfo[0].shape)) __pyx_t_27 = 0;
        if (unlikely(__pyx_t_27 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_27);
          __PYX_ERR(0, 41, __pyx_L1_error)
        }
        __pyx_t_21 = ((__pyx_v_tmp < (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_dist_neighbors.diminfo[0].strides))) != 0);
        if (__pyx_t_21) {

          /* "find_new_clusters.pyx":42
 *             for k in range(n_neighbors):
 *                 if tmp < dist_neighbors[k]:
 *                     dist_neighbors[k:] = np.roll(dist_neighbors[k:], 1)             # <<<<<<<<<<<<<<
 *                     neighbors[k:] = np.roll(neighbors[k:], 1)
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_roll); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_k); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_4 = PySlice_New(__pyx_t_5, Py_None, Py_None); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_dist_neighbors), __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_4 = NULL;
          __pyx_t_27 = 0;
          ...
          if (PyFunction_Check(__pyx_t_1)) {
            ...
            __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_27, 2+__pyx_t_27); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
            PyObject *__pyx_temp[3] = {__pyx_t_4, __pyx_t_5, __pyx_int_1};
            __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_27, 2+__pyx_t_27); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
            __Pyx_GOTREF(__pyx_t_3);
            __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          } else
          #endif
          {
            __pyx_t_2 = PyTuple_New(2+__pyx_t_27); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_2);
            if (__pyx_t_4) {
              __Pyx_GIVEREF(__pyx_t_4); PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_t_4); __pyx_t_4 = NULL;
            }
            __Pyx_GIVEREF(__pyx_t_5);
            PyTuple_SET_ITEM(__pyx_t_2, 0+__pyx_t_27, __pyx_t_5);
            __Pyx_INCREF(__pyx_int_1);
            __Pyx_GIVEREF(__pyx_int_1);
            PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_27, __pyx_int_1);
            __pyx_t_5 = 0;
          ...
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_dist_neighbors), __pyx_t_2, __pyx_t_3) < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

          /* "find_new_clusters.pyx":43
 *                 if tmp < dist_neighbors[k]:
 *                     dist_neighbors[k:] = np.roll(dist_neighbors[k:], 1)
 *                     neighbors[k:] = np.roll(neighbors[k:], 1)             # <<<<<<<<<<<<<<
 *                     dist_neighbors[k] = tmp
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_2);
          __pyx_t_5 = PySlice_New(__pyx_t_2, Py_None, Py_None); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = __Pyx_PyObject_GetItem(((PyObject *)__pyx_v_neighbors), __pyx_t_5); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = NULL;
          __pyx_t_27 = 0;
          ...
          if (PyFunction_Check(__pyx_t_1)) {
            ...
            __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_27, 2+__pyx_t_27); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
          ...
          if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
            PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_2, __pyx_int_1};
            __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_27, 2+__pyx_t_27); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 43, __pyx_L1_error)
            __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
            __Pyx_GOTREF(__pyx_t_3);
            __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          } else
          #endif
          {
            __pyx_t_4 = PyTuple_New(2+__pyx_t_27); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 43, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_4);
            if (__pyx_t_5) {
              __Pyx_GIVEREF(__pyx_t_5); PyTuple_SET_ITEM(__pyx_t_4, 0, __pyx_t_5); __pyx_t_5 = NULL;
            }
            __Pyx_GIVEREF(__pyx_t_2);
            PyTuple_SET_ITEM(__pyx_t_4, 0+__pyx_t_27, __pyx_t_2);
            __Pyx_INCREF(__pyx_int_1);
            __Pyx_GIVEREF(__pyx_int_1);
            PyTuple_SET_ITEM(__pyx_t_4, 1+__pyx_t_27, __pyx_int_1);
            __pyx_t_2 = 0;
          ...
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
          if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_neighbors), __pyx_t_4, __pyx_t_3) < 0)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

          /* "find_new_clusters.pyx":44
 *                     dist_neighbors[k:] = np.roll(dist_neighbors[k:], 1)
 *                     neighbors[k:] = np.roll(neighbors[k:], 1)
 *                     dist_neighbors[k] = tmp             # <<<<<<<<<<<<<<
 *                     neighbors[k] = j
 ...
 */
          ...
          __pyx_t_27 = -1;
          if (__pyx_t_28 < 0) {
            __pyx_t_28 += __pyx_pybuffernd_dist_neighbors.diminfo[0].shape;
            if (unlikely(__pyx_t_28 < 0)) __pyx_t_27 = 0;
          } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_dist_neighbors.diminfo[0].shape)) __pyx_t_27 = 0;
          if (unlikely(__pyx_t_27 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_27);
            __PYX_ERR(0, 44, __pyx_L1_error)
          }
          *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_dist_neighbors.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_dist_neighbors.diminfo[0].strides) = __pyx_v_tmp;

          /* "find_new_clusters.pyx":45
 *                     neighbors[k:] = np.roll(neighbors[k:], 1)
 *                     dist_neighbors[k] = tmp
 *                     neighbors[k] = j             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
          ...
          } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_neighbors.diminfo[0].shape)) __pyx_t_27 = 0;
          if (unlikely(__pyx_t_27 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_27);
            __PYX_ERR(0, 45, __pyx_L1_error)
          }
          *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_neighbors.diminfo[0].strides) = __pyx_v_j;

          /* "find_new_clusters.pyx":46
 *                     dist_neighbors[k] = tmp
 *                     neighbors[k] = j
 *                     break             # <<<<<<<<<<<<<<
 *         for k in range(n_neighbors):
 ...
 */
      ...
      } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_neighbors.diminfo[0].shape)) __pyx_t_20 = 0;
      if (unlikely(__pyx_t_20 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_20);
        __PYX_ERR(0, 48, __pyx_L1_error)
      }
      __pyx_t_3 = __Pyx_PyInt_From_npy_long(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_neighbors.diminfo[0].strides)) - __pyx_v_l)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 48, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_21 = (__Pyx_PySequence_ContainsTF(__pyx_t_3, ((PyObject *)__pyx_v_rejected_inds), Py_EQ)); if (unlikely(__pyx_t_21 < 0)) __PYX_ERR(0, 48, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_31 = (__pyx_t_21 != 0);
      if (__pyx_t_31) {

        /* "find_new_clusters.pyx":49
 *         for k in range(n_neighbors):
 *             if neighbors[k] - l in rejected_inds:
 *                 pairs[it, 0] = rejected_inds[i]             # <<<<<<<<<<<<<<
 *                 pairs[it, 1] = neighbors[k] - l
 ...
 */
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_32 < 0) {
          __pyx_t_32 += __pyx_pybuffernd_rejected_inds.diminfo[0].shape;
          if (unlikely(__pyx_t_32 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_rejected_inds.diminfo[0].shape)) __pyx_t_20 = 0;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          __PYX_ERR(0, 49, __pyx_L1_error)
        }
        __pyx_t_33 = __pyx_v_it;
        __pyx_t_34 = 0;
        __pyx_t_20 = -1;
        if (__pyx_t_33 < 0) {
          __pyx_t_33 += __pyx_pybuffernd_pairs.diminfo[0].shape;
          if (unlikely(__pyx_t_33 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_33 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_20 = 0;
        if (__pyx_t_34 < 0) {
          __pyx_t_34 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_34 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_34 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_20 = 1;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          __PYX_ERR(0, 49, __pyx_L1_error)
        }
        *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_33, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_34, __pyx_pybuffernd_pairs.diminfo[1].strides) = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer.buf, __pyx_t_32, __pyx_pybuffernd_rejected_inds.diminfo[0].strides));

        /* "find_new_clusters.pyx":50
 *             if neighbors[k] - l in rejected_inds:
 *                 pairs[it, 0] = rejected_inds[i]
 *                 pairs[it, 1] = neighbors[k] - l             # <<<<<<<<<<<<<<
 *                 it = it + 1
 ...
 */
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_pybuffernd_neighbors.diminfo[0].shape;
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_35 >= __pyx_pybuffernd_neighbors.diminfo[0].shape)) __pyx_t_20 = 0;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
        ...
        __pyx_t_20 = -1;
        if (__pyx_t_36 < 0) {
          __pyx_t_36 += __pyx_pybuffernd_pairs.diminfo[0].shape;
          if (unlikely(__pyx_t_36 < 0)) __pyx_t_20 = 0;
        } else if (unlikely(__pyx_t_36 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_20 = 0;
        if (__pyx_t_37 < 0) {
          __pyx_t_37 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_37 < 0)) __pyx_t_20 = 1;
        } else if (unlikely(__pyx_t_37 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_20 = 1;
        if (unlikely(__pyx_t_20 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_20);
          __PYX_ERR(0, 50, __pyx_L1_error)
        }
        *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_37, __pyx_pybuffernd_pairs.diminfo[1].strides) = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_neighbors.rcbuffer->pybuffer.buf, __pyx_t_35, __pyx_pybuffernd_neighbors.diminfo[0].strides)) - __pyx_v_l);

        /* "find_new_clusters.pyx":51
 *                 pairs[it, 0] = rejected_inds[i]
 *                 pairs[it, 1] = neighbors[k] - l
 *                 it = it + 1             # <<<<<<<<<<<<<<
 *     # return pairs
 ...
 *         else:
 */
    __pyx_t_38 = PyList_GET_SIZE(__pyx_v_clusters); if (unlikely(__pyx_t_38 == ((Py_ssize_t)-1))) __PYX_ERR(0, 55, __pyx_L1_error)
    __pyx_t_31 = ((__pyx_t_38 == 0) != 0);
    if (__pyx_t_31) {

      /* "find_new_clusters.pyx":56
 *     for j in range(it):
 *         if len(clusters) == 0:
 *             clusters.append([pairs[j, 0], pairs[j, 1]])             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_39 < 0) {
        __pyx_t_39 += __pyx_pybuffernd_pairs.diminfo[0].shape;
        if (unlikely(__pyx_t_39 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_39 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
      if (__pyx_t_40 < 0) {
        __pyx_t_40 += __pyx_pybuffernd_pairs.diminfo[1].shape;
        if (unlikely(__pyx_t_40 < 0)) __pyx_t_18 = 1;
      } else if (unlikely(__pyx_t_40 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
      if (unlikely(__pyx_t_18 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_18);
        __PYX_ERR(0, 56, __pyx_L1_error)
      }
      __pyx_t_3 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_39, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_40, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_41 = __pyx_v_j;
      __pyx_t_42 = 1;
      __pyx_t_18 = -1;
      if (__pyx_t_41 < 0) {
        __pyx_t_41 += __pyx_pybuffernd_pairs.diminfo[0].shape;
        if (unlikely(__pyx_t_41 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_41 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
      if (__pyx_t_42 < 0) {
        __pyx_t_42 += __pyx_pybuffernd_pairs.diminfo[1].shape;
        if (unlikely(__pyx_t_42 < 0)) __pyx_t_18 = 1;
      } else if (unlikely(__pyx_t_42 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
      if (unlikely(__pyx_t_18 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_18);
        __PYX_ERR(0, 56, __pyx_L1_error)
      }
      __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_41, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_42, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_3 = 0;
      __pyx_t_4 = 0;
      __pyx_t_43 = __Pyx_PyList_Append(__pyx_v_clusters, __pyx_t_1); if (unlikely(__pyx_t_43 == ((int)-1))) __PYX_ERR(0, 56, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
      __pyx_t_1 = __pyx_v_clusters; __Pyx_INCREF(__pyx_t_1); __pyx_t_38 = 0;
      for (;;) {
        if (__pyx_t_38 >= PyList_GET_SIZE(__pyx_t_1)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_4 = PyList_GET_ITEM(__pyx_t_1, __pyx_t_38); __Pyx_INCREF(__pyx_t_4); __pyx_t_38++; if (unlikely(0 < 0)) __PYX_ERR(0, 59, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_1, __pyx_t_38); __pyx_t_38++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 59, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
        __Pyx_XDECREF_SET(__pyx_v_cluster, __pyx_t_4);
        __pyx_t_4 = 0;

        /* "find_new_clusters.pyx":60
 *             i = 0
 *             for cluster in clusters:
 *                 if pairs[j, 0] in cluster:             # <<<<<<<<<<<<<<
 *                     if pairs[j, 1] not in cluster:
 ...
 */
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_44 < 0) {
          __pyx_t_44 += __pyx_pybuffernd_pairs.diminfo[0].shape;
          if (unlikely(__pyx_t_44 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_44 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_45 < 0) {
          __pyx_t_45 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_45 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_45 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 60, __pyx_L1_error)
        }
        __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_31 = (__Pyx_PySequence_ContainsTF(__pyx_t_4, __pyx_v_cluster, Py_EQ)); if (unlikely(__pyx_t_31 < 0)) __PYX_ERR(0, 60, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_21 = (__pyx_t_31 != 0);
        if (__pyx_t_21) {

          /* "find_new_clusters.pyx":61
 *             for cluster in clusters:
 *                 if pairs[j, 0] in cluster:
 *                     if pairs[j, 1] not in cluster:             # <<<<<<<<<<<<<<
 *                         cluster.append(pairs[j, 1])
 ...
 */
          ...
          __pyx_t_18 = -1;
          if (__pyx_t_46 < 0) {
            __pyx_t_46 += __pyx_pybuffernd_pairs.diminfo[0].shape;
            if (unlikely(__pyx_t_46 < 0)) __pyx_t_18 = 0;
          } else if (unlikely(__pyx_t_46 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
          if (__pyx_t_47 < 0) {
            __pyx_t_47 += __pyx_pybuffernd_pairs.diminfo[1].shape;
            if (unlikely(__pyx_t_47 < 0)) __pyx_t_18 = 1;
          } else if (unlikely(__pyx_t_47 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
          if (unlikely(__pyx_t_18 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_18);
            __PYX_ERR(0, 61, __pyx_L1_error)
          }
          __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 61, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_21 = (__Pyx_PySequence_ContainsTF(__pyx_t_4, __pyx_v_cluster, Py_NE)); if (unlikely(__pyx_t_21 < 0)) __PYX_ERR(0, 61, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_31 = (__pyx_t_21 != 0);
          if (__pyx_t_31) {

            /* "find_new_clusters.pyx":62
 *                 if pairs[j, 0] in cluster:
 *                     if pairs[j, 1] not in cluster:
 *                         cluster.append(pairs[j, 1])             # <<<<<<<<<<<<<<
 *                 elif pairs[j, 1] in cluster:
 ...
 */
            ...
            __pyx_t_18 = -1;
            if (__pyx_t_48 < 0) {
              __pyx_t_48 += __pyx_pybuffernd_pairs.diminfo[0].shape;
              if (unlikely(__pyx_t_48 < 0)) __pyx_t_18 = 0;
            } else if (unlikely(__pyx_t_48 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
            if (__pyx_t_49 < 0) {
              __pyx_t_49 += __pyx_pybuffernd_pairs.diminfo[1].shape;
              if (unlikely(__pyx_t_49 < 0)) __pyx_t_18 = 1;
            } else if (unlikely(__pyx_t_49 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
            if (unlikely(__pyx_t_18 != -1)) {
              __Pyx_RaiseBufferIndexError(__pyx_t_18);
              __PYX_ERR(0, 62, __pyx_L1_error)
            }
            __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_49, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 62, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_4);
            __pyx_t_43 = __Pyx_PyObject_Append(__pyx_v_cluster, __pyx_t_4); if (unlikely(__pyx_t_43 == ((int)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
        ...
        } else if (unlikely(__pyx_t_50 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_51 < 0) {
          __pyx_t_51 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_51 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_51 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 63, __pyx_L1_error)
        }
        __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_50, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_51, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 63, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_31 = (__Pyx_PySequence_ContainsTF(__pyx_t_4, __pyx_v_cluster, Py_EQ)); if (unlikely(__pyx_t_31 < 0)) __PYX_ERR(0, 63, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_21 = (__pyx_t_31 != 0);
        if (__pyx_t_21) {

          /* "find_new_clusters.pyx":64
 *                         cluster.append(pairs[j, 1])
 *                 elif pairs[j, 1] in cluster:
 *                     if pairs[j, 0] not in cluster:             # <<<<<<<<<<<<<<
 *                         cluster.append(pairs[j, 0])
 ...
 */
          ...
          } else if (unlikely(__pyx_t_52 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
          if (__pyx_t_53 < 0) {
            __pyx_t_53 += __pyx_pybuffernd_pairs.diminfo[1].shape;
            if (unlikely(__pyx_t_53 < 0)) __pyx_t_18 = 1;
          } else if (unlikely(__pyx_t_53 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
          if (unlikely(__pyx_t_18 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_18);
            __PYX_ERR(0, 64, __pyx_L1_error)
          }
          __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_52, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_53, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 64, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __pyx_t_21 = (__Pyx_PySequence_ContainsTF(__pyx_t_4, __pyx_v_cluster, Py_NE)); if (unlikely(__pyx_t_21 < 0)) __PYX_ERR(0, 64, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __pyx_t_31 = (__pyx_t_21 != 0);
          if (__pyx_t_31) {

            /* "find_new_clusters.pyx":65
 *                 elif pairs[j, 1] in cluster:
 *                     if pairs[j, 0] not in cluster:
 *                         cluster.append(pairs[j, 0])             # <<<<<<<<<<<<<<
 *                 # it is a new cluster
 ...
 */
            ...
            __pyx_t_18 = -1;
            if (__pyx_t_54 < 0) {
              __pyx_t_54 += __pyx_pybuffernd_pairs.diminfo[0].shape;
              if (unlikely(__pyx_t_54 < 0)) __pyx_t_18 = 0;
            } else if (unlikely(__pyx_t_54 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
            if (__pyx_t_55 < 0) {
              __pyx_t_55 += __pyx_pybuffernd_pairs.diminfo[1].shape;
              if (unlikely(__pyx_t_55 < 0)) __pyx_t_18 = 1;
            } else if (unlikely(__pyx_t_55 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
            if (unlikely(__pyx_t_18 != -1)) {
              __Pyx_RaiseBufferIndexError(__pyx_t_18);
              __PYX_ERR(0, 65, __pyx_L1_error)
            }
            __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_54, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_55, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 65, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_4);
            __pyx_t_43 = __Pyx_PyObject_Append(__pyx_v_cluster, __pyx_t_4); if (unlikely(__pyx_t_43 == ((int)-1))) __PYX_ERR(0, 65, __pyx_L1_error)
            __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
      __pyx_t_38 = PyList_GET_SIZE(__pyx_v_clusters); if (unlikely(__pyx_t_38 == ((Py_ssize_t)-1))) __PYX_ERR(0, 69, __pyx_L1_error)
      __pyx_t_31 = ((__pyx_v_i == __pyx_t_38) != 0);
      if (__pyx_t_31) {

        /* "find_new_clusters.pyx":70
 *                     i += 1
 *             if i == len(clusters):
 *                 clusters.append([pairs[j, 0], pairs[j, 1]])             # <<<<<<<<<<<<<<
 *     # merge clusters if they have intersections
 ...
 */
        ...
        __pyx_t_18 = -1;
        if (__pyx_t_56 < 0) {
          __pyx_t_56 += __pyx_pybuffernd_pairs.diminfo[0].shape;
          if (unlikely(__pyx_t_56 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_56 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_57 < 0) {
          __pyx_t_57 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_57 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_57 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 70, __pyx_L1_error)
        }
        __pyx_t_1 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_56, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_57, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_58 = __pyx_v_j;
        __pyx_t_59 = 1;
        __pyx_t_18 = -1;
        if (__pyx_t_58 < 0) {
          __pyx_t_58 += __pyx_pybuffernd_pairs.diminfo[0].shape;
          if (unlikely(__pyx_t_58 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_58 >= __pyx_pybuffernd_pairs.diminfo[0].shape)) __pyx_t_18 = 0;
        if (__pyx_t_59 < 0) {
          __pyx_t_59 += __pyx_pybuffernd_pairs.diminfo[1].shape;
          if (unlikely(__pyx_t_59 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_59 >= __pyx_pybuffernd_pairs.diminfo[1].shape)) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 70, __pyx_L1_error)
        }
        __pyx_t_4 = __Pyx_PyInt_From_npy_long((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_pairs.rcbuffer->pybuffer.buf, __pyx_t_58, __pyx_pybuffernd_pairs.diminfo[0].strides, __pyx_t_59, __pyx_pybuffernd_pairs.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 70, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        ...
        __pyx_t_1 = 0;
        __pyx_t_4 = 0;
        __pyx_t_43 = __Pyx_PyList_Append(__pyx_v_clusters, __pyx_t_3); if (unlikely(__pyx_t_43 == ((int)-1))) __PYX_ERR(0, 70, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  __pyx_t_38 = PyList_GET_SIZE(__pyx_v_clusters); if (unlikely(__pyx_t_38 == ((Py_ssize_t)-1))) __PYX_ERR(0, 72, __pyx_L1_error)
  __pyx_v_num_clusters = __pyx_t_38;

  /* "find_new_clusters.pyx":73
 *     # merge clusters if they have intersections
 *     cdef int num_clusters = len(clusters)
 *     cdef np.ndarray[np.int_t, ndim = 1] to_keep = np.ones(num_clusters, dtype=np.int)             # <<<<<<<<<<<<<<
 *     for i in range(num_clusters):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_ones); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_num_clusters); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_1, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (!(likely(((__pyx_t_5) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_5, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 73, __pyx_L1_error)
  __pyx_t_60 = ((PyArrayObject *)__pyx_t_5);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_to_keep.rcbuffer->pybuffer, (PyObject*)__pyx_t_60, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_to_keep = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 73, __pyx_L1_error)
    } else {__pyx_pybuffernd_to_keep.diminfo[0].strides = __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_to_keep.diminfo[0].shape = __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_60 = 0;
  __pyx_v_to_keep = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "find_new_clusters.pyx":74
 *     cdef int num_clusters = len(clusters)
 *     cdef np.ndarray[np.int_t, ndim = 1] to_keep = np.ones(num_clusters, dtype=np.int)
 *     for i in range(num_clusters):             # <<<<<<<<<<<<<<
 *         for j in range(i + 1, num_clusters):
 ...
 */
  __pyx_t_8 = __pyx_v_num_clusters;
  __pyx_t_15 = __pyx_t_8;
  for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_15; __pyx_t_17+=1) {
    __pyx_v_i = __pyx_t_17;

    /* "find_new_clusters.pyx":75
 *     cdef np.ndarray[np.int_t, ndim = 1] to_keep = np.ones(num_clusters, dtype=np.int)
 *     for i in range(num_clusters):
 *         for j in range(i + 1, num_clusters):             # <<<<<<<<<<<<<<
 *             if to_keep[j] == 0 or to_keep[i] == 0:
 *                 continue
 */
    __pyx_t_18 = __pyx_v_num_clusters;
    __pyx_t_20 = __pyx_t_18;
    for (__pyx_t_24 = (__pyx_v_i + 1); __pyx_t_24 < __pyx_t_20; __pyx_t_24+=1) {
      __pyx_v_j = __pyx_t_24;

      /* "find_new_clusters.pyx":76
 *     for i in range(num_clusters):
 *         for j in range(i + 1, num_clusters):
 *             if to_keep[j] == 0 or to_keep[i] == 0:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      __pyx_t_25 = -1;
      if (__pyx_t_61 < 0) {
        __pyx_t_61 += __pyx_pybuffernd_to_keep.diminfo[0].shape;
        if (unlikely(__pyx_t_61 < 0)) __pyx_t_25 = 0;
      } else if (unlikely(__pyx_t_61 >= __pyx_pybuffernd_to_keep.diminfo[0].shape)) __pyx_t_25 = 0;
      if (unlikely(__pyx_t_25 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_25);
        __PYX_ERR(0, 76, __pyx_L1_error)
      }
      __pyx_t_21 = (((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.buf, __pyx_t_61, __pyx_pybuffernd_to_keep.diminfo[0].strides)) == 0) != 0);
      if (!__pyx_t_21) {
      } else {
      ...
      __pyx_t_25 = -1;
      if (__pyx_t_62 < 0) {
        __pyx_t_62 += __pyx_pybuffernd_to_keep.diminfo[0].shape;
        if (unlikely(__pyx_t_62 < 0)) __pyx_t_25 = 0;
      } else if (unlikely(__pyx_t_62 >= __pyx_pybuffernd_to_keep.diminfo[0].shape)) __pyx_t_25 = 0;
      if (unlikely(__pyx_t_25 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_25);
        __PYX_ERR(0, 76, __pyx_L1_error)
      }
      __pyx_t_21 = (((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.buf, __pyx_t_62, __pyx_pybuffernd_to_keep.diminfo[0].strides)) == 0) != 0);
      __pyx_t_31 = __pyx_t_21;
      __pyx_L28_bool_binop_done:;
      if (__pyx_t_31) {

        /* "find_new_clusters.pyx":77
 *         for j in range(i + 1, num_clusters):
 *             if to_keep[j] == 0 or to_keep[i] == 0:
 *                 continue             # <<<<<<<<<<<<<<
 *             if np.intersect1d(clusters[i], clusters[j]).size != 0:
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_intersect1d); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_GetItemInt_List(__pyx_v_clusters, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_clusters, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_2 = NULL;
      __pyx_t_25 = 0;
      if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_1))) {
      ...
      if (PyFunction_Check(__pyx_t_1)) {
        ...
        __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_25, 2+__pyx_t_25); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_1)) {
        PyObject *__pyx_temp[3] = {__pyx_t_2, __pyx_t_3, __pyx_t_4};
        __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_1, __pyx_temp+1-__pyx_t_25, 2+__pyx_t_25); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      #endif
      {
        __pyx_t_63 = PyTuple_New(2+__pyx_t_25); if (unlikely(!__pyx_t_63)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_63);
        if (__pyx_t_2) {
          __Pyx_GIVEREF(__pyx_t_2); PyTuple_SET_ITEM(__pyx_t_63, 0, __pyx_t_2); __pyx_t_2 = NULL;
        }
        __Pyx_GIVEREF(__pyx_t_3);
        PyTuple_SET_ITEM(__pyx_t_63, 0+__pyx_t_25, __pyx_t_3);
        __Pyx_GIVEREF(__pyx_t_4);
        PyTuple_SET_ITEM(__pyx_t_63, 1+__pyx_t_25, __pyx_t_4);
        __pyx_t_3 = 0;
        __pyx_t_4 = 0;
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_63, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_63); __pyx_t_63 = 0;
      }
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_size); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyInt_NeObjC(__pyx_t_1, __pyx_int_0, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_31 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_31 < 0)) __PYX_ERR(0, 78, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      if (__pyx_t_31) {

        /* "find_new_clusters.pyx":79
 *                 continue
 *             if np.intersect1d(clusters[i], clusters[j]).size != 0:
 *                 clusters[i].extend(np.setdiff1d(clusters[j], clusters[i]))             # <<<<<<<<<<<<<<
 *                 to_keep[j] = 0
 ...
 */
        __pyx_t_1 = __Pyx_GetItemInt_List(__pyx_v_clusters, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_63 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_extend); if (unlikely(!__pyx_t_63)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_63);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_setdiff1d); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_clusters, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_2 = __Pyx_GetItemInt_List(__pyx_v_clusters, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_64 = NULL;
        __pyx_t_25 = 0;
        if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
          __pyx_t_64 = PyMethod_GET_SELF(__pyx_t_3);
        ...
        if (PyFunction_Check(__pyx_t_3)) {
          PyObject *__pyx_temp[3] = {__pyx_t_64, __pyx_t_4, __pyx_t_2};
          __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_25, 2+__pyx_t_25); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
        ...
        if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
          PyObject *__pyx_temp[3] = {__pyx_t_64, __pyx_t_4, __pyx_t_2};
          __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_25, 2+__pyx_t_25); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
          __Pyx_XDECREF(__pyx_t_64); __pyx_t_64 = 0;
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        ...
        #endif
        {
          __pyx_t_65 = PyTuple_New(2+__pyx_t_25); if (unlikely(!__pyx_t_65)) __PYX_ERR(0, 79, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_65);
          if (__pyx_t_64) {
            __Pyx_GIVEREF(__pyx_t_64); PyTuple_SET_ITEM(__pyx_t_65, 0, __pyx_t_64); __pyx_t_64 = NULL;
          }
          __Pyx_GIVEREF(__pyx_t_4);
          PyTuple_SET_ITEM(__pyx_t_65, 0+__pyx_t_25, __pyx_t_4);
          __Pyx_GIVEREF(__pyx_t_2);
          PyTuple_SET_ITEM(__pyx_t_65, 1+__pyx_t_25, __pyx_t_2);
          __pyx_t_4 = 0;
          __pyx_t_2 = 0;
          __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_65, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 79, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_1);
          __Pyx_DECREF(__pyx_t_65); __pyx_t_65 = 0;
        }
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_3 = NULL;
        if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_63))) {
        ...
        __pyx_t_5 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_63, __pyx_t_3, __pyx_t_1) : __Pyx_PyObject_CallOneArg(__pyx_t_63, __pyx_t_1);
        __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
        ...
        __pyx_t_25 = -1;
        if (__pyx_t_66 < 0) {
          __pyx_t_66 += __pyx_pybuffernd_to_keep.diminfo[0].shape;
          if (unlikely(__pyx_t_66 < 0)) __pyx_t_25 = 0;
        } else if (unlikely(__pyx_t_66 >= __pyx_pybuffernd_to_keep.diminfo[0].shape)) __pyx_t_25 = 0;
        if (unlikely(__pyx_t_25 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_25);
          __PYX_ERR(0, 80, __pyx_L1_error)
        }
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_to_keep.rcbuffer->pybuffer.buf, __pyx_t_66, __pyx_pybuffernd_to_keep.diminfo[0].strides) = 0;
 ...
 */
  ...
  /* "find_new_clusters.pyx":82
 *                 to_keep[j] = 0
 *     # clusters_arr = np.array(clusters)[to_keep]
 *     return np.array(clusters)[to_keep == 1]             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __Pyx_GetModuleGlobalName(__pyx_t_63, __pyx_n_s_np); if (unlikely(!__pyx_t_63)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_63);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_63, __pyx_n_s_array); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_63); __pyx_t_63 = 0;
  __pyx_t_63 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_1))) {
  ...
  __pyx_t_5 = (__pyx_t_63) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_63, __pyx_v_clusters) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_v_clusters);
  __Pyx_XDECREF(__pyx_t_63); __pyx_t_63 = 0;
  if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_RichCompare(((PyObject *)__pyx_v_to_keep), __pyx_int_1, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 82, __pyx_L1_error)
  __pyx_t_63 = __Pyx_PyObject_GetItem(__pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_63)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_63);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (!(likely(((__pyx_t_63) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_63, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 82, __pyx_L1_error)
  __pyx_r = ((PyArrayObject *)__pyx_t_63);
  __pyx_t_63 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_rejected_inds.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_to_keep.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_x.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("find_new_clusters.c_find_new_clusters", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_dist_matrix.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_17find_new_clusters_1c_find_new_clusters(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_17find_new_clusters_1c_find_new_clusters(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_x = 0;
  int __pyx_v_l;
  PyArrayObject *__pyx_v_rejected_inds = 0;
  int __pyx_v_n_neighbors;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("c_find_new_clusters (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_l,&__pyx_n_s_rejected_inds,&__pyx_n_s_n_neighbors,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_l)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("c_find_new_clusters", 1, 4, 4, 1); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rejected_inds)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("c_find_new_clusters", 1, 4, 4, 2); __PYX_ERR(0, 15, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_neighbors)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("c_find_new_clusters", 1, 4, 4, 3); __PYX_ERR(0, 15, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "c_find_new_clusters") < 0)) __PYX_ERR(0, 15, __pyx_L3_error)
      }
    ...
    __pyx_v_l = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_l == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_rejected_inds = ((PyArrayObject *)values[2]);
    __pyx_v_n_neighbors = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_n_neighbors == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("c_find_new_clusters", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 15, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("find_new_clusters.c_find_new_clusters", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_rejected_inds), __pyx_ptype_5numpy_ndarray, 1, "rejected_inds", 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_r = __pyx_pf_17find_new_clusters_c_find_new_clusters(__pyx_self, __pyx_v_x, __pyx_v_l, __pyx_v_rejected_inds, __pyx_v_n_neighbors);
...
static PyObject *__pyx_pf_17find_new_clusters_c_find_new_clusters(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x, int __pyx_v_l, PyArrayObject *__pyx_v_rejected_inds, int __pyx_v_n_neighbors) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_rejected_inds;
  __Pyx_Buffer __pyx_pybuffer_rejected_inds;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_x;
  __Pyx_Buffer __pyx_pybuffer_x;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_17find_new_clusters_c_find_new_clusters(__pyx_v_x, __pyx_v_l, __pyx_v_rejected_inds, __pyx_v_n_neighbors, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"c_find_new_clusters", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_17find_new_clusters_1c_find_new_clusters, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_find_new_clusters(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_find_new_clusters},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_rejected_inds, __pyx_k_rejected_inds, sizeof(__pyx_k_rejected_inds), 0, 0, 1, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  __pyx_float_1_0e_31 = PyFloat_FromDouble(1.0e+31); if (unlikely(!__pyx_float_1_0e_31)) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initfind_new_clusters(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initfind_new_clusters(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_find_new_clusters(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_find_new_clusters(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_find_new_clusters(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'find_new_clusters' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_find_new_clusters(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("find_new_clusters", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_find_new_clusters) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "find_new_clusters")) {
      if (unlikely(PyDict_SetItemString(modules, "find_new_clusters", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_sklearn_metrics_pairwise, __pyx_t_1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_euclidean_distances); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_euclidean_distances, __pyx_t_1) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "find_new_clusters.pyx":5
 * from cpython cimport array
 * from sklearn.metrics.pairwise import euclidean_distances
 * import array             # <<<<<<<<<<<<<<
 * 
 * cdef float euclidean_distance(np.ndarray[np.float_t, ndim = 1] x_i, np.ndarray[np.float_t, ndim = 1] x_j):
 */
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_array, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init find_new_clusters", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init find_new_clusters");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
